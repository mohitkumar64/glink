...
import { idlFactory } from './glink_backend.did.js';
export { idlFactory } from './glink_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GLINK_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./glink_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the glink_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./glink_backend.did.js")._SERVICE>}
 */
export const glink_backend = createActor(canisterId);
